...
export function MovieWidget() {
  return (
    ...
    >
      ...
      <WidgetLink.HoverInfo className='absolute bottom-0 w-full p-2 text-white bg-gradient-to-t from-black/80 to-transparent backdrop-blur-md rounded-b-md'>
        <div className='flex flex-col gap-2'>
          <h2 className='text-lg font-semibold'>Movies</h2>
          <p className='text-sm'>Discover the latest movies.</p>
        </div>
      </WidgetLink.HoverInfo>
    </WidgetLink>
  );
}
